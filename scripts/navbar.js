  ...
  if (navbarEl) {
    navbarEl.innerHTML = `
        ...
        <nav id="navbar">
            ...
            <li class="home-li"><a class="active-link" aria-current="page" href="index.html"><h4>Home</h4></a></li>
            <li><a href="index.html#main_title"><h4>About</h4></a></li>
            <li><a href="index.html#edu_title"><h4>Education</h4></a></li>
            <li><a href="projects.html"><h4>Projects</h4></a></li>
            </ul>
        </nav>
